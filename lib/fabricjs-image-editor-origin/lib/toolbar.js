...
(function () {
    ...
    var defaultButtons = [{
        ...
        name: 'upload',
        title: 'Upload image',
        icon: `<svg id="Capa_1" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve"><path d="m 500.8061,395.50922 c 0,22.55431 -18.45123,41.00914 -41.00553,41.00914 H 49.698365 c -22.554305,0 -41.0055303,-18.45122 -41.0055303,-41.00914 V 83.826778 c 0,-22.554305 18.4512253,-41.00553 41.0055303,-41.00553 H 459.80057 c 22.5543,0 41.00553,18.451225 41.00553,41.00553 z M 49.698365,75.627837 c -4.355687,0 -8.195332,3.85408 -8.195332,8.195332 V 395.50561 c 0,4.35569 3.843253,8.19534 8.195332,8.19534 H 459.80057 c 4.34125,0 8.20616,-3.83965 8.20616,-8.19534 V 83.823169 c 0,-4.341252 -3.86491,-8.195332 -8.20616,-8.195332 z M 123.52491,206.8578 c -27.169809,0 -49.226114,-22.04187 -49.226114,-49.20447 0,-27.1626 22.056305,-49.21529 49.226114,-49.21529 27.15899,0 49.19365,22.05269 49.19365,49.21529 0,27.1626 -22.03105,49.20447 -49.19365,49.20447 z M 435.1857,370.90518 H 74.298796 v -49.22251 l 82.025484,-82.00384 41.00553,40.9947 L 328.55978,149.458 435.1857,256.08393 Z" style="stroke-width:3.60869" /></svg>`
    }, {
        name: 'background',
        title: 'Canvas option',
    ...
    const defaultExtendedButtons = [{
        ...
        name: 'save',
        title: 'Save',
        icon: `<svg x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve"><path style="fill:#000000" d="m 105.30822,424.38119 c -12.882821,-3.16705 -22.087501,-12.48662 -25.139501,-25.45328 -1.96111,-8.33189 -1.96111,-313.963009 0,-322.294889 1.74339,-7.40695 5.64624,-13.91425 10.89511,-18.16568 9.872791,-7.99665 14.795441,-8.87155 47.744381,-8.48559 l 25.5,0.29871 0.5,54.499999 c 0.5592,60.95303 0.11323,57.41909 7.85347,62.23239 l 3.64653,2.26761 h 82 82 l 3.5,-2.18093 c 1.925,-1.19951 4.4,-3.67451 5.5,-5.5 1.91663,-3.18072 2.02084,-5.56994 2.5,-57.31907 l 0.5,-53.999999 16.96946,-0.27517 16.96946,-0.27517 34.28054,34.26973 34.28054,34.269739 V 255.4758 c 0,97.57229 -0.32399,138.73697 -1.12161,142.50544 -2.87418,13.57945 -12.31627,23.28127 -25.73094,26.43872 -7.95338,1.87201 -315.02494,1.83511 -322.64744,-0.0388 z m 280.98819,-87.60073 c -0.0118,-54.44128 -0.0143,-54.50613 -2.29875,-60.18826 -3.03826,-7.55697 -10.11602,-14.96078 -17.68945,-18.50436 l -6,-2.80738 h -93.5 -93.5 l -6,2.80738 c -7.58006,3.54668 -14.65376,10.94879 -17.68335,18.50436 -2.25865,5.63289 -2.28408,6.20772 -2.61232,59.05143 -0.1823,29.34974 -0.0913,53.98907 0.20228,54.75406 0.45246,1.17909 18.69868,1.35221 119.81357,1.13684 l 119.27982,-0.25407 z M 283.80821,92.780461 v -43 h 17 17 v 43 42.999999 h -17 -17 z" id="path303" /></svg>`
    }, {
        name: 'download',
        title: 'Download',
        ...
        `);
            ...
            (() => {
                ...
                $(`${this.containerSelector} #toolbar .extended-buttons button`).click(function () {
                    let id = $(this).attr('id');
                    if (id === 'save') {
                        window.parent.saveAnnotation(_self.canvas.toJSON(), _self.canvas.toDataURL(''));
                        window.lastSavedJson = _self.canvas.toJSON();
                    } else if (id === 'clear') {
                        if (window.confirm('Revert to last save?')) {
